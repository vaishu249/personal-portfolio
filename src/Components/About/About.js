      ...
      <div className='service-wraper'>
        ...
        <div className='service-card'>
          ...
          <i className="fa-solid fa-gears"></i>
            ...
            <p>
            As a detail-oriented software tester, I possess a solid understanding 
            of both manual and automated testing methodologies to ensure the 
            delivery of high-quality software products. My expertise includes 
            creating comprehensive test plans, writing test cases, and executing 
            functional, regression, and performance testing to identify bugs and 
